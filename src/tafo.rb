...
puts(
  ...
  when /[ (](SELECT|INSERT INTO|UPDATE|DELETE|BEGIN|COMMIT) /
    l.gsub(/SELECT|INSERT INTO|UPDATE|DELETE|INNER JOIN|LEFT OUTER JOIN|ORDER BY|SET|FROM|VALUES|WHERE|ON|AND|OR|IS|AS|CAST|LIKE|DESC|LIMIT \d+|BEGIN|COMMIT|GROUP BY/) { |m|
